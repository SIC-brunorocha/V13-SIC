...
{
    'name': 'Process Costing Manufacturing with By-Products',
    'version': '13.0.0.0',
    'category': 'Manufacturing',
    'summary': 'Apps for process costing on mrp with by-products cost bom process costing process costing mrp bill of material costing mrp accounting cost mrp material cost mrp labour cost manufacturing overhead cost Manufacturing total costing mrp by product cost',
    'description': """
...
""",
    ...
    'depends': ['sale_management','mrp','bi_odoo_process_costing_manufacturing'],
    'data': [
            'security/ir.model.access.csv',
            'views/custom_mrp_view.xml',
            'report/inherit_mrp_bom_report_view.xml',
            'report/inherit_mrp_production_report_view.xml',
    ],
    'installable': True,
    'auto_install': False,
    "live_test_url":'https://youtu.be/S4Lbsy-S2x0',
